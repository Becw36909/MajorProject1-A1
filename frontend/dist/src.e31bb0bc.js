...
class SignUpView {
  ...
  async signUpSubmitHandler(e) {
    ...
    const accessLevel = (_document$querySelect5 = document.querySelector("input[name='accessLevel']:checked")) === null || _document$querySelect5 === void 0 ? void 0 : _document$querySelect5.value; // Basic validations
...
class HorseView {
  ...
  render() {
    ...
    const template = (0, _litHtml.html)(_templateObject(), horse.name, _Router.anchorRoute, horse.breed || "—", horse.age || "—", horse.height || "—", horse.sex || "—", horse.colour || "—", horse.microchipNumber || "—", horse.notes || "No notes available.", services.length > 0 ? (0, _litHtml.html)(_templateObject2(), services.map(service => (0, _litHtml.html)(_templateObject3(), service.serviceType, service.notes || "No notes provided", (0, _moment.default)(service.date).format("DD MMM YYYY")))) : (0, _litHtml.html)(_templateObject4()), horse.image ? "".concat(_App.default.apiBase, "/images/").concat(horse.image) : "", () => document.getElementById("delete-horse-modal").show(), () => this.deleteHorse(), () => document.getElementById("delete-horse-modal").hide());
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
